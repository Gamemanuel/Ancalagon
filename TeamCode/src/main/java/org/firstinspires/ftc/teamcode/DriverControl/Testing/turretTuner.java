...
public class turretTuner extends OpMode {
    ...
    public void loop() {
        ...
        telemetry.addData("kP", "%.3f", robot.turretAuto.kP);
        telemetry.addData("MIN_POWER", "%.2f", robot.turretAuto.MIN_POWER);
        telemetry.addData("MAX_POWER", "%.2f", robot.turretAuto.MAX_POWER);
        telemetry.addData("DEADZONE", "%.1f°", robot.turretAuto.DEADZONE);
